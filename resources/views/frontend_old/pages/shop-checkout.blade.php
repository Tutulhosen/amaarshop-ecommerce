                ...
                <ul role="list" class="payment-details">
                    ...
                    <form id="checkout-form">
                        ...
                        <div class="input-group">
                            ...
                            <div>
                                <label for="additional-address" >Your Location <br>
								
								<span style="margin-bottom: 8px !important;">(It's necessary for delivery charge)</span> <span style="color: red;">*</span></label>
