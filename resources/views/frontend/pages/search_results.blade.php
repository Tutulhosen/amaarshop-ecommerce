                    ...
                    <div class="col-md-2 col-6 main-product">
                        <div class="main-product-inner-wrapper text-center product-item">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="submit" data-id="{{ $product->id }}" data-price="{{ $discount_price }}" data-qnt="1" class="btn btn-sm w-100 mb-2 add_cart_btn_direct" name="add_cart" value="অর্ডার করুন">
                            </form>
                        </div>
                    </div>
                @endforeach
